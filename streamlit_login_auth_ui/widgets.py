                    ...
                    if valid_email_check == True:
                        if unique_email_check == True:
                            if unique_username_check == True:
                                ...
                                user_folder = os.path.join(os.path.dirname(__file__), '../users', username_sign_up)
                                os.makedirs(user_folder, exist_ok=True)

                                os.makedirs(user_folder + '/data', exist_ok=True)  # 创建data子文件夹
                                os.makedirs(user_folder + '/models', exist_ok=True)  # 创建models子文件夹
